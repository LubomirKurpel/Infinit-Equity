...
contract InfinitEquity_Key is ERC721, ERC721Enumerable, ReentrancyGuard, Ownable, AccessControl {
	...
	constructor(address _referralContractAddress) ERC721("Infinit Equity - Key", "Key") Ownable() {
	...
	function mintKey(string memory referral) public nonReentrant payable {
		...
		/*
		console.log("Minted token ID:", total);
		console.log("- Key mint end -");
		*/
	...
	/*
	function checkUSDCaddress() external {
