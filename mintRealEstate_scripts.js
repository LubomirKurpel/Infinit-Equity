...
async function onConnect() {
	...
	if (chainId == global.chainID) {
		...
		var keyContract = await global.getContract(web3, "realEstatesContract");
...
async function onMint() {
	...
	var realEstatesContract = await global.getContract(web3, "realEstatesContract");
	...
	await realEstatesContract.methods.mintKey(quantity, "").send({
		from: userAddress
	}).on('confirmation', function() {
